...
# 2020-01-01 부터 현재까지 ≈ 2300일
_DAYS_SINCE_2020 = 2300
...
CREATE TABLE IF NOT EXISTS collection_config (
    ...
    days_back       INTEGER DEFAULT 2300,
...
_DEFAULT_KEYWORDS = [
    ...
    # Advanced Materials (신소재)
    ("graphene",                       "advanced_materials"),
    ("carbon nanotube",                "advanced_materials"),
    ("metamaterial",                   "advanced_materials"),
    ("MXene",                          "advanced_materials"),
    ("self-healing material",          "advanced_materials"),
    ("2D material",                    "advanced_materials"),
    ("room-temperature superconductor","advanced_materials"),
    # Web3 & Blockchain
    ("zero-knowledge proof",           "web3_blockchain"),
    ("decentralized finance",          "web3_blockchain"),
    ("smart contract",                 "web3_blockchain"),
    ("tokenization",                   "web3_blockchain"),
    ("real world asset",               "web3_blockchain"),
    ("layer 2 blockchain",             "web3_blockchain"),
    # Climate Tech
